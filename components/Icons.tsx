...
export function CloudIcon({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 15a4.5 4.5 0 0 0 4.5 4.5H18a3.75 3.75 0 0 0 1.995-7.002A6 6 0 0 0 6.75 9.75c0-1.932.923-3.646 2.354-4.725" />
    </svg>
  );
}
...
export function LogoIcon({ className = "h-8 w-8" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 32 32" fill="none">
      ...
      <path d="M8 22V10h3.2l3.6 7.2L18.4 10H21.6v12h-2.8v-7.4L15.6 22h-2.4l-3.2-7.4V22H8z" fill="white" />
    </svg>
  );
}
